<!-- Content
		...
		<div class="row clearfix bottommargin-lg common-height">
                    ...
                    <div class="col-md-3 col-sm-6 dark center col-padding">
                        <div>
			    <img class="" src="<?php echo site_url();?>application/assests/images/TeamMate/order.png">
			<div class="pickanddeliver1">
			    ...
			    <a class="pricesmall1 drycl">Order through mobile,tablet or Desktop</a>
                    ...
                    <div class="col-md-3 col-sm-6 dark center col-padding">
                        <div>
			    <img class="" src="<?php echo site_url();?>application/assests/images/TeamMate/collect.png">
			<div class="pickanddeliver1">
			    ...
			    <a class="pricesmall1 drycl">Choose a time and place that suit you</a>
                    ...
                    <div class="col-md-3 col-sm-6 dark center col-padding">
                        <div>
			    <img class="" src="<?php echo site_url();?>application/assests/images/TeamMate/clean.png">
			<div class="pickanddeliver1">
			    ...
			    <a class="pricesmall1 drycl">Your clothes are given a high quality clean</a>
                    ...
                    <div class="col-md-3 col-sm-6 dark center col-padding">
                        <div>
			    <img class="" src="<?php echo site_url();?>application/assests/images/TeamMate/delever.png">
			<div class="pickanddeliver1">
